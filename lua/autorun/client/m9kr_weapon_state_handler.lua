...
print("[M9K:R] Centralized weapon state handler loaded (CLIENT)")
print("[M9K:R] - Handles: ADS/Scope, Sprint, Safety, USE key idle forcing, Reload state")
print("[M9K:R] - Manages: Viewmodel visibility, FOV transitions, Mouse sensitivity")
print("[M9K:R] - Supports: Scoped weapons, Bolt action, Shotguns, Akimbo, Silenced weapons")
print("[M9K:R] - Precached ADS sounds: ironin.wav, ironout.wav")
